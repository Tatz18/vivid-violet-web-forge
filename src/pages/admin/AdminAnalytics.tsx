      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            View insights and performance metrics for your properties and content
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monthly property additions to your portfolio</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={propertyData}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="properties" fill="hsl(var(--primary))" />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
