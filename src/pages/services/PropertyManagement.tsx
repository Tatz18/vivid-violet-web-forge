  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-primary/5 to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">24/7 Maintenance Services</h2>
            <p className="text-xl text-gray-600">Quick response maintenance with certified professionals</p>
          </div>
              ...
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  <div className="text-center mb-4">
                    <div className="text-4xl mb-3">{maintenance.icon}</div>
                    <h3 className="text-lg font-semibold text-gray-900">{maintenance.category}</h3>
                  </div>
                  ...
                  <div className="border-t pt-3">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="text-sm font-medium text-primary">{maintenance.responseTime}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Management Packages</h2>
            <p className="text-xl text-gray-600">Choose the right management package for your property portfolio</p>
          </div>
              ...
              <Card key={index} className={`relative overflow-hidden hover:shadow-xl transition-shadow ${pkg.popular ? 'ring-2 ring-primary' : ''}`}>
                ...
                <CardContent className={`p-8 ${pkg.popular ? 'pt-12' : ''}`}>
                  <div className="text-center mb-8">
                    ...
                    <div className="text-gray-600 text-sm mb-2">{pkg.period}</div>
                    <Badge className="bg-blue-100 text-blue-800">{pkg.properties}</Badge>
                  </div>
